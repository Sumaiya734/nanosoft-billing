...
@section('title', 'Test Package Creation')

@section('content')
<div class="container-fluid p-4">
    <h1>Test Package Creation</h1>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h2>Form Test</h2>
            <form id="testForm" method="POST" action="{{ route('admin.packages.store') }}">
                @csrf
                <div class="mb-3">
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                alert('Package created: ' + (data.message || 'Success'));
            })
            .catch(error => {
