        ...
        <div class="col-xl-3 col-md-6">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title text-muted mb-2">Regular Products</h6>
                            <h3 class="mb-0">{{ $stats['regular_products'] ?? 0 }}</h3>
                        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title text-muted mb-2">Special Products</h6>
                            <h3 class="mb-0">{{ $stats['special_products'] ?? 0 }}</h3>
                        </div>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">{{ $product->type->name ?? 'N/A' }}</small>
                                    </div>
                                </div>
                            </td>
                            <td>
